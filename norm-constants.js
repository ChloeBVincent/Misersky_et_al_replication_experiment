...
const all_translations = {
    "English": {
        ...
        "FOR THE NEXT 3 TEXTS, xxxx and yyyy will be replaced by women or men (based on the variables label_ratio) depending on the scale order. ": "",
...
//    "instructions_Dutch.html": "<strong>INSTRUCTIES</strong> \n<p>In deze studie zijn we geïnteresseerd in wat mensen denken dat de genderverhoudingen zijn binnen  \nverschillende groepen. Zijn de meeste juweliers in Nederland vrouwen of juist mannen, of is het een 50/50 split?</p> \n<p>Tijdens deze taak krijg je 25 zelfstandige naamwoorden te zien die verwijzen naar bepaalde groepen  \n(zoals ‘juweliers’). Bij elk zelfstandig naamwoord vragen we je om met behulp van een schaal aan te geven  \nwat je denkt dat de verhouding is tussen mannen en vrouwen in Nederland binnen deze groep. Het gaat hier  \nalleen om jouw inschatting van de huidige stand van zaken in Nederland; je hoeft het niet zeker te weten.</p> \n<p>Als je klaar bent om te beginnen, klik dan op ‘Beginnen’.</p>",
//    "instructions_English.html": "<strong>INSTRUCTIONS</strong> \n<p>In this study, we are interested in what people think the gender ratios are within  \ndifferent groups. Are most jewellers in the Netherlands women or men, or is it a 50/50 split?</p> \n<p>During this task, you will be shown 25 nouns that refer to specific groups  \n(such as ‘jewellers’). For each noun, we ask you to use a scale to indicate  \nwhat you think the ratio of men to women is in the Netherlands within this group. This is  \nsimply your estimate of the current situation in the Netherlands; you do not need to know for certain.</p> \n<p>When you are ready to begin, please click ‘Start’.</p>",
//    "instructions_French.html": "<strong>Instruction</strong> \n<p>Plutôt hommes ou femmes? ou 50 50 ? </p> \n<p>Tijdens deze taak krijg je 25 zelfstandige naamwoorden te zien die verwijzen naar bepaalde groepen  \n(zoals ‘juweliers’). Bij elk zelfstandig naamwoord vragen we je om met behulp van een schaal aan te geven  \nwat je denkt dat de verhouding is tussen mannen en vrouwen in Nederland binnen deze groep. Het gaat hier  \nalleen om jouw inschatting van de huidige stand van zaken in Nederland; je hoeft het niet zeker te weten.</p> \n<p>Als je klaar bent om te beginnen, klik dan op ‘Beginnen’.</p>"
};
